...
class ImgUpload
{
    ...
    */
    public function __construct($di, $width=100, $height=100, $allow_types = '') 
    {
        $this->di=$di;
    ...
    */
    public function upload_file($files, $path)
    {
        //处理图片命名
        ...
        if($error == 0 && is_uploaded_file($files['tmp_name']))
        {
            //检测文件类型 
            ...
            //缩放比例后存储 
            if($this->resizeImage($files['tmp_name'], $this->max_width, $this->max_height, $this->md5_time,'.jpg'))
            {
